  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <Card className="rounded-2xl">
        <CardHeader>
          <CardTitle className="text-center font-serif text-2xl">Create your account</CardTitle>
        ...
        <CardContent className="space-y-6">
          <form action={handleSubmit} className="space-y-4">
            ...
            {state?.success && (
              <div className="bg-chart-3/10 border border-chart-3/50 text-chart-3 px-4 py-3 rounded-full text-sm">
                {state.success}
              </div>
            )}
